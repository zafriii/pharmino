...
// import TabNavigation from "@/components/shared ui/TabNavigation";

// interface MenuTabsProps {
//   activeTab: string;
// }

// const MenuTabs: React.FC<MenuTabsProps> = ({ activeTab }) => {
//   const tabs = [    
//     {
//       id: "products",
//       label: "Products",
...
//   return (
//     <div className="mb-6">
//       <TabNavigation tabs={tabs} activeTabId={activeTab} />
//     </div>
//   );
// };
